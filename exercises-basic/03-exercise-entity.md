...
```
Le nom de l'entité sera `Article`.
...
Maintenant que notre entité est créée, allez dans votre dossier `src`, un dossier Entity a été ajouté. Il contient votre nouvelle entité.
